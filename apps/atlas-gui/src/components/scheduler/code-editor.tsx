  ...
  return (
    <div className="space-y-2">
      <textarea
        ...
        rows={rows}
        spellCheck={false}
        className="block w-full rounded-md border border-input bg-background px-4 py-3 font-mono text-sm leading-relaxed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
      />
